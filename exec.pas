...
{$I exec.h}
implementation
uses arrow, caseditto, ch, charcmd, code, eqsgetrep, file_module, frame,
        help, line, mark, newword, nextbridge_module, opsys, quit_module,
        screen, span, swap, tpar, text, user,
        validate_module, vduibm, window, word;
{#elseif vms}
%include 'const.inc/nolist'
%include 'type.inc/nolist'
%include 'var.inc/nolist'

%include 'exec.fwd/nolist'
%include 'arrow.ext/nolist'
%include 'caseditto.ext/nolist'
%include 'ch.ext/nolist'
%include 'charcmd.ext/nolist'
%include 'code.ext/nolist'
%include 'eqsgetrep.ext/nolist'
%include 'file_module.ext/nolist'
%include 'frame.ext/nolist'
%include 'help.ext/nolist'
%include 'line.ext/nolist'
%include 'mark.ext/nolist'
%include 'newword.ext/nolist'
%include 'nextbridge.ext/nolist'
%include 'opsys.ext/nolist'
%include 'quit_module.ext/nolist'
%include 'screen.ext/nolist'
%include 'span.ext/nolist'
%include 'swap.ext/nolist'
%include 'tpar.ext/nolist'
%include 'text.ext/nolist'
%include 'user.ext/nolist'
%include 'validate.ext/nolist'
%include 'vdu.ext/nolist'
%include 'vdu_vms.ext/nolist'
%include 'window.ext/nolist'
%include 'word.ext/nolist'
  ...
  with current_frame^,dot^ do
    ...
    if command in [cmd_noop..cmd_do_last_command] then
      case command of
        ...
        cmd_ditto_down,
        cmd_ditto_up:
          cmd_success := function_caseditto(command,rept,count,from_span);
        ...
        cmd_up:
          ...
          then
            ...
            if line^.flink = nil then
              ...
              cmd_success := function_arrow(command,rept,count,from_span);
              end
            else
