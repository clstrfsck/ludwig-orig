...
! 4-002 John Warburton                                       11-May-1989
!       Added a new option to the frame_options set. This option, when
!       set will ask the user if they want to save a frame that has been
!       written to, but no output file specified.
!--}
