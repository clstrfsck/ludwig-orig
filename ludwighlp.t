...
{ fk[] fo"/notab"
{ uk/keypad-7/zh/  uk/keypad-1/zh23zd/
{
...
\FO
 ...
 ==      ===========
   ...
   Opens an output file for the current frame.  If trailing parameter is
 ...
 field removed. If not given, the default device and directory are used,
 which may not be the same as those of the attached input file.
